...
<head>
    ...
    {{-- Perbaikan: Menggunakan Vite --}}
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-100 font-sans min-h-screen text-zinc-900">
    ...
    <aside class="w-64 bg-gray-900 text-white fixed inset-y-0 left-0 z-20 flex flex-col">
        ...
        <nav class="mt-10 px-6 space-y-3 overflow-y-auto nice-scroll">
            {{-- 1. DASHBOARD --}}
            ...
            <a href="{{ route('admin.comingsoon-movie.index') }}"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4h10a2 2 0 012 2v2H5V6a2 2 0 012-2zM5 8h14v12a2 2 0 01-2 2H7a2 2 0 01-2 2H7a2 2 0 01-2-2V8zM8 8l2-4m4 4l2-4m-10 4l2-4" /></svg>
            ...
            <a href="{{ route('admin.reports.ticket_sales') }}"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18M7 15l4-4 4 3 5-6" /></svg>
        ...
        <div class="p-6 border-t border-gray-800 space-y-2 mt-auto">
            <a href="{{ route('home') }}" class="flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-white transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9.75L12 4l9 5.75V20a1 1 0 01-1 1h-5v-6H9v6H4a1 1 0 01-1-1V9.75z" /></svg>
                Kembali ke Home
            </a>
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="w-full text-left px-4 py-2 text-gray-400 hover:text-white transition">Logout</button>
            </form>
        </div>
    </aside>
